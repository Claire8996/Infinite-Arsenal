...
public class MushroomAI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool isAttacking = stateInfo.IsName("Mushroom_Attack01Angry");
        bool isGettingHit = stateInfo.IsName("Mushroom_GetHitAngry");
        bool isDying = stateInfo.IsName("Mushroom_DieAngry");
        ...
        if (distance <= attackRange)
        {
            ...
            else ChangeAnimation("Mushroom_IdleBattleAngry");
        }
        else
        {
            Chase();
    ...
    void Chase()
    {
        ...
        ChangeAnimation("Mushroom_walkFWDAngry");
    }
    ...
    void Attack()
    {
        ...
        ChangeAnimation("Mushroom_Attack01Angry");
    ...
    public void TakeDamage(int damageAmount)
    {
        ...
        else
        {
            ...
            ChangeAnimation("Mushroom_GetHitAngry");
        }
    }
    ...
    void Die()
    {
        ...
        ChangeAnimation("Mushroom_DieAngry");
